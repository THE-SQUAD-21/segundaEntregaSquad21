...
INSERT INTO `alunos` VALUES (5,'jhuniohenrique@gmail.com','Junio','junio_henrique','0000','Henrique','99999999');
...
CREATE TABLE `matriculas` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKrwsrt4qf6q7fghkawume7g1ya` (`aluno_id`),
  KEY `FKtgxnkauqy13npoi9q2t9n0ol5` (`curso_id`),
  CONSTRAINT `FKrwsrt4qf6q7fghkawume7g1ya` FOREIGN KEY (`aluno_id`) REFERENCES `alunos` (`id`),
...
-- Dump completed on 2023-11-20 21:41:26
